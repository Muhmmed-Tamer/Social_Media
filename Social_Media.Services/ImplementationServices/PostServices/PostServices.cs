            ...
            try
            {
                ...
                foreach (var Post in PostsOFUser)
                {
                    foreach (var ImageOrVideoPath in Post?.ImageOrVideo_Paths)
                    {
                        ...
                        if (await FileServices.GetExtensionTypeOFFile(Extension) == ExtensionType.Image)
                        {
                        ...
                        else if (await FileServices.GetExtensionTypeOFFile(Extension) == ExtensionType.Video)
                        {
