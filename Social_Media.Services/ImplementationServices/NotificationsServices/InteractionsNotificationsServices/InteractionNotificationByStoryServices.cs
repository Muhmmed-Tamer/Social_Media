...
namespace Social_Media.InfraStructure.ImplementationRepositories.NotificationsRepository.InteractionsNotificationsRepository
{
    ...
    {
        public InteractionNotificationByStoryServices(ILogger<Services<InteractionNotificationByStory>> Logger, IRepository<InteractionNotificationByStory> Repository) : base(Logger, Repository)
        {
        }
