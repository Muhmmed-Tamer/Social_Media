...
namespace Social_Media.InfraStructure.ImplementationRepositories.NotificationsRepository.InteractionsNotificationsRepository
{
    ...
    {
        public InteractionNotificationByCommentServices(ILogger<Services<InteractionNotificationByComment>> Logger, IRepository<InteractionNotificationByComment> Repository) : base(Logger, Repository)
        {
        }
