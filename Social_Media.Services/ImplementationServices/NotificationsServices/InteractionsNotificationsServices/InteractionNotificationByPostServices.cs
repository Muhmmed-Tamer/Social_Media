...
namespace Social_Media.InfraStructure.ImplementationRepositories.NotificationsRepository.InteractionsNotificationsRepository
{
    ...
    {
        public InteractionNotificationByPostServices(ILogger<Services<InteractionNotificationByPost>> Logger, IRepository<InteractionNotificationByPost> Repository) : base(Logger, Repository)
        {
        }
