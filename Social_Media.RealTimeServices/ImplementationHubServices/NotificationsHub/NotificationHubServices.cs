...
namespace Social_Media.RealTimeServices.ImplementationHubServices.NotificationsHub
{
    public class NotificationHubServices
    {
        ...
        public async Task NotifyOwnerOFPostAboutComment(string UserId, object Data)
        {
            try
            {
                UserConnection UserConnectionOFUserThatOwnedPost = await UserConnectionRepository.GetByUserId(UserId);
                ...
                await NotificationHubContext.Clients.Client(UserConnectionOFUserThatOwnedPost.ConnectionId).SendAsync("ReceiveNewCommentInPost", Data);
            }
            catch (Exception ex)
            {
        ...
        public async Task NotifyUserAboutSendFriendRequestFromAnotherUser(string UserId, object Data)
        {
            try
            {
                ...
                UserConnection UserConnectionOFUserThatReceiveNewFriendRequestNotification = await UserConnectionRepository.GetByUserId(UserId);
                ...
                await NotificationHubContext.Clients.Client(UserConnectionOFUserThatReceiveNewFriendRequestNotification.ConnectionId).SendAsync("ReceiveNewFriendRequest", Data);
            }
            catch (Exception ex)
            {
        ...
        public async Task NotifyUserAboutConfirmFriendRequestFromAnotherUser(string UserId, object Data)
        {
            try
            {
                ...
                await NotificationHubContext.Clients.Client(UserConnectionOFUserThatReceiveNewFriendRequestNotification.ConnectionId).SendAsync("ReceiveConfirmFriendRequest", Data);
            }
            catch (Exception ex)
            {
                Logger.Error(ex.Message, ex);
