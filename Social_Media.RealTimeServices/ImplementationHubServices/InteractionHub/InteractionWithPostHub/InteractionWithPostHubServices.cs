    ...
    public class InteractionWithPostHubServices
    {
        ...
        public async Task NotifyOwnerOFPostAboutInteraction(string UserId, object Data)
        {
            try
            {
                ...
                UserConnection UserConnectionOFUserThatReceiveNewInteractionWithPostNotification = await UserConnectionRepository.GetByUserId(UserId);
                ...
                await InteractionWithPostHubContext.Clients.Client(UserConnectionOFUserThatReceiveNewInteractionWithPostNotification.ConnectionId).SendAsync("ReceiveNewInteractionWithPost", Data);
            }
            catch (Exception ex)
            {
