    ...
    public class InteractionWithCommentHubServices
    {
        ...
        public async Task NotifyOwnerOFCommentAboutInteraction(string UserId, object Data)
        {
            try
            {
                ...
                UserConnection UserConnectionOFUserThatReceiveNewInteractionWithCommentNotification = await UserConnectionRepository.GetByUserId(UserId);
                ...
                await InteractionWithPostHubContext.Clients.Client(UserConnectionOFUserThatReceiveNewInteractionWithCommentNotification.ConnectionId).SendAsync("ReceiveNewInteractionWithComment", Data);
            }
            catch (Exception ex)
            {
